...
#define RXD1 44//WORKING WITH THESE PINS on 4/15, also this RXD1 define here goes to TX out on adafruit module, SO IT IS flipped like online ppl were saying
#define TXD1 43 //if using both 39 and 36 for GPIO, it bugs out, so seeing if I can use 39 and 15.
